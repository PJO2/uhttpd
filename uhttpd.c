// --------------------------------------------------------
// uhttpd : a minimal web server which compile under 
//          MacOS, Linux and Windows
//          by Ph. Jounin November 2019
// 
// This is the one file version (wget https://github.com/
// 
// License: GPLv2
// Sources : 
...
const char SYNTAX[] = ""
UWEB_FLAVOR ": Usage\n"
"\n" UWEB_FLAVOR "     [-4|-6] [-p port] [-d dir] [-i addr] [-c content-type|-ct|-cb]"
...
char sbuf[MAX_PATH];
	...
	if (!SetCurrentDirectory (sSettings.szDirectory))
        ...
        LOG (WARN, "%s is listening on port %s, base directory is %s\n", 
                    UWEB_FLAVOR,
